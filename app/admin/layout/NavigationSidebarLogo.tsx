...
/**
 * Props accepted by the <NavigationSidebarLogo> component.
 */
interface NavigationSidebarLogoProps {
    /**
     * Name of the CSS class created by the styled engine.
     */
    className?: string;
}

/**
 * Component that displays the Volunteer Manager logo in the sidebar. The logo's an SVG that can
 * contain both the actual image colours, and be stylised towards the palette's primary colour.
 */
        ...
        <Box className={props.className}>
            <SvgIcon viewBox="40 40 418 418">
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    ...
                    { /* (0) Background */ }
                    <circle r="220" cy="250" cx="250" className="background" />
                    ...
                    <g>
                        ...
                        <path style={{ fill: '#ffffff', stroke: 'none' }} fillRule="evenodd"
                        ...
                        <path style={{ fill: '#f3b317', stroke: 'none' }} fillRule="evenodd"
