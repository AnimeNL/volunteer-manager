...
const kEventSaleCategoryOptions: { [k in EventSalesCategory]: string } = {
    ...
    Hidden: 'Hidden',
    Locker: 'Locker',
    LockerFriday: 'Locker (Friday)',
    LockerSaturday: 'Locker (Saturday)',
    LockerSunday: 'Locker (Sunday)',
    LockerWeekend: 'Locker (Weekend)',
...
/**
 * Props accepted by the <SettingsDataTable> component.
 */
...
/**
 * The <SettingsDataTable> component allows the administrator to configure how imported sales data
 * should be interpretet and displayed within the Volunteer Manager.
 */
export function SettingsDataTable(props: SettingsDataTableProps) {
