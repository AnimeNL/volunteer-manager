...
export class TrainingsTable extends Table<DBConnection, 'TrainingsTable'> {
    ...
    trainingStart = this.columnWithDefaultValue<Temporal.ZonedDateTime>('training_start', 'customLocalDateTime', 'dateTime', TemporalTypeAdapter);
    trainingEnd = this.columnWithDefaultValue<Temporal.ZonedDateTime>('training_end', 'customLocalDateTime', 'dateTime', TemporalTypeAdapter);
