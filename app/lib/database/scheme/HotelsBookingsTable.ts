...
export class HotelsBookingsTable extends Table<DBConnection, 'HotelsBookingsTable'> {
    ...
    bookingCheckIn = this.columnWithDefaultValue<Temporal.PlainDate>('booking_check_in', 'customLocalDate', 'date', TemporalTypeAdapter);
    bookingCheckOut = this.columnWithDefaultValue<Temporal.PlainDate>('booking_check_out', 'customLocalDate', 'date', TemporalTypeAdapter);
