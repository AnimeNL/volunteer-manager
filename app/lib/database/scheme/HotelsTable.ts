...
export class HotelsTable extends Table<DBConnection, 'HotelsTable'> {
    ...
    hotelRoomCreated = this.columnWithDefaultValue<ZonedDateTime>('hotel_room_created', 'customLocalDateTime', 'dateTime', TemporalTypeAdapter);
    hotelRoomDeleted = this.optionalColumnWithDefaultValue<ZonedDateTime>('hotel_room_deleted', 'customLocalDateTime', 'dateTime', TemporalTypeAdapter);
