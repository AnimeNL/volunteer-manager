...
export class ContentCategoryTable extends Table<DBConnection, 'ContentCategoryTable'> {
    ...
    categoryCreated = this.column<Temporal.ZonedDateTime>('category_created', 'customLocalDateTime', 'dateTime', TemporalTypeAdapter);
    categoryUpdated = this.column<Temporal.ZonedDateTime>('category_updated', 'customLocalDateTime', 'dateTime', TemporalTypeAdapter);
    categoryDeleted = this.optionalColumnWithDefaultValue<Temporal.ZonedDateTime>('category_deleted', 'customLocalDateTime', 'dateTime', TemporalTypeAdapter);
