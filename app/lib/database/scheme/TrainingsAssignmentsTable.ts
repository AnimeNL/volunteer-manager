...
export class TrainingsAssignmentsTable extends Table<DBConnection, 'TrainingsAssignmentsTable'> {
    ...
    assignmentUpdated = this.optionalColumnWithDefaultValue<Temporal.ZonedDateTime>('assignment_updated', 'customLocalDateTime', 'timestamp', TemporalTypeAdapter);
    ...
    preferenceUpdated = this.optionalColumnWithDefaultValue<Temporal.ZonedDateTime>('preference_updated', 'customLocalDateTime', 'timestamp', TemporalTypeAdapter);
