...
export class ActivitiesTable extends Table<DBConnection, 'ActivitiesTable'> {
    ...
    activityCreated = this.column<Temporal.ZonedDateTime>('activity_created', 'customLocalDateTime', 'dateTime', TemporalTypeAdapter);
    activityUpdated = this.column<Temporal.ZonedDateTime>('activity_updated', 'customLocalDateTime', 'dateTime', TemporalTypeAdapter);
    activityDeleted = this.optionalColumnWithDefaultValue<Temporal.ZonedDateTime>('activity_deleted', 'customLocalDateTime', 'dateTime', TemporalTypeAdapter);
