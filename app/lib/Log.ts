...
export const kLogType = {
    ...
    AdminDeleteAvatar: 'admin-delete-avatar',
    AdminDeleteDutyBook: 'admin-delete-duty-book',
    ...
    AdminEventApplicationClaim: 'admin-event-application-claim',
    AdminEventApplicationMove: 'admin-event-application-move',
    AdminEventApplicationRelease: 'admin-event-application-release',
    ...
    AdminEventWebsiteSettingsUpdate: 'admin-event-website-settings-update',
    ...
    AdminUpdateDutyBookDetails: 'admin-update-duty-book-details',
    AdminUpdateDutyBookVisibility: 'admin-update-duty-book-visibility',
